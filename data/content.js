...
export const FEATURED_PROJECTS = [
  ...
  },
  {
    ...
    kpis: [
      ...
      { num: '+13.6%', label: 'ΔError, 95% CI [+10.4%, +16.8%] — HellaSwag reconstruction-penalty delta, Layer 12 causal' },
    ...
    result: `Four findings from one pipeline. <strong>(1) Rigorous predictive null on HellaSwag</strong> — for binary multiple-choice correctness, SAE features don't yield incremental accuracy over raw activations at Layer 12 (Δ(P3 − P2) = +0.032, 95% CI [−0.006, +0.071]); coarse MC labels hide representational nuance. <strong>(2) Continuous difficulty preservation on SQuAD</strong> — swapping MC for continuous gold-target perplexities reveals a robust signal: raw residual activations predict perplexity difficulty at AUROC <strong>0.668</strong> (CI [0.635, 0.700]), significantly beating cheap lexical stats (0.626) and capturing 31% of Oracle AURC. <strong>(3) ECE recovery via Platt</strong> — high-dimensional L1 probes are severely miscalibrated, but 5-fold OOF Platt drops ECE 65–70% (Input-Stats 0.309 → 0.085, SAE 0.265 → 0.092), delivering deployment-grade selective QA. <strong>(4) Causal reconstruction penalty</strong> — replacing Layer 12 states with their TopK SAE reconstruction degrades Pythia-410M zero-shot accuracy by +13.6% on HellaSwag (80.27% recon error vs 66.67% natural) and +82.27% on SQuAD; individual top-5 feature ablations are causally neutral — difficulty features represent <em>collective predictive manifolds</em>, not isolated steerable dimensions.`,
    tagline: `An end-to-end, leakage-controlled study proving that while SAE interpretability is high, its difficulty-predictive signal is a compressed equivalent to raw activations — and that swapping binary benchmarks for continuous perplexity distributions is the key to unlocking feature-routed LLM routing cascades.`
  },
  {
