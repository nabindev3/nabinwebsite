...
export const FEATURED_PROJECTS = [
  {
    ...
    stack: `<strong>Backbone:</strong> Chronos-T5-small (60 M, T5 encoder-decoder, LM-style training on quantized numeric tokens)<br><strong>Interpretability:</strong> TopK Sparse Autoencoder (8× expansion, d_hidden=4096, k=32, aux-revival) · Encoder block hooks<br><strong>Probing:</strong> L1 logistic · TimeSeriesSplit cross-validation · Paired bootstrap (2 000 iterations) for ΔAUROC CIs<br><strong>Selective prediction:</strong> Risk-coverage curves · AURC · Oracle/random baselines<br><strong>Storage:</strong> safetensors (per-token fp16) · Parquet (train-only-normalized labels) · seasonal-naive MASE (m = 24)<br><strong>Ops:</strong> Hard guardrails (probe refuses on unlabeled data or random-init SAE) · One-command reproduce.sh · pinned env`,
    ...
    result: `Two findings from one pipeline, neither reframed post-hoc. (1) A rigorous <strong>null</strong> for the SAE-features-add-incremental-difficulty-signal hypothesis at chronos-t5-small's mid-encoder, with paired-bootstrap CIs that don't cross zero. (2) A positive <strong>selective-prediction</strong> result on the same data: the input-statistics probe is itself a usable forecast-abstention signal that captures 30% of the oracle's available AURC improvement. The novelty wedge — label-free, inference-time difficulty prediction for routing/abstention — remains unclaimed in the 2026 literature: Mishra (arXiv:2603.10071) did causal ablation, TimeSAE (arXiv:2601.09776) did post-hoc black-box explanation, neither did this. Workshop-formatted manuscript, one-command reproducible pipeline, hard methodology guardrails in code.`,
